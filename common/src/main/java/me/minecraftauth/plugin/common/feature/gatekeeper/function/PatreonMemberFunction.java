...
public class PatreonMemberFunction extends AbstractFunction {

    public PatreonMemberFunction(GatekeeperFeature gatekeeper, Supplier<MinecraftAccount> accountSupplier) {
        super(gatekeeper, "PatreonMember", -1, accountSupplier);
    }
