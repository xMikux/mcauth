...
public class TwitchFollowerFunction extends AbstractFunction {

    public TwitchFollowerFunction(GatekeeperFeature gatekeeper, Supplier<MinecraftAccount> accountSupplier) {
        super(gatekeeper, "TwitchFollower", 0, accountSupplier);
    }
